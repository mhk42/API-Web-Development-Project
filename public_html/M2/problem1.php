...
function processArray($arr) {
    ...
    //mhk42, 9/21/23, the code below creates a new empty array named final, then a for loop is used to go through arr to copy odd values to final array using an if statement.
    // then a foreach loop is used to print the final array.
	$final = [];
